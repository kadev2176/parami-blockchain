...
const TRANSACTION_VERSION: u32 = parami_runtime::VERSION.transaction_version;

const SPEC_VERSION: u32 = parami_runtime::VERSION.spec_version;
...
fn bench_execute_block(c: &mut Criterion) {
    c.bench_function_over_inputs(
        ...
        |b, strategy| {
            let genesis_config =
                parami_testing::genesis::config(false, Some(compact_code_unwrap()));
