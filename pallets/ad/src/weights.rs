...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    ...
    // Storage: Tag TagsOf (r:1 w:1)
    // Storage: Ad Metadata (r:0 w:1)
    fn create(n: u32, ) -> Weight {
        (0 as Weight)
            // Standard Error: 6_000
            .saturating_add((5_938_000 as Weight).saturating_mul(n as Weight))
    ...
    fn update_tags(n: u32, ) -> Weight {
        (0 as Weight)
            ...
            .saturating_add((5_954_000 as Weight).saturating_mul(n as Weight))
