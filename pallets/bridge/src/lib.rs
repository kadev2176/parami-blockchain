...
use frame_support::{
    traits::{Currency, EnsureOrigin, ExistenceRequirement::KeepAlive, WithdrawReasons},
    transactional,
};
...
#[derive(Clone, Decode, Encode, Eq, Ord, PartialEq, PartialOrd, RuntimeDebug, TypeInfo)]
...
pub mod pallet {
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn desposit(
            ...
            let who = ensure_signed(origin)?;
            let actual =
                value.saturating_add(UniqueSaturatedInto::<BalanceOf<T>>::unique_saturated_into(
