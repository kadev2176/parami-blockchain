...
pub use primitives::{BlockNumber, Balance, Moment, AssetId, ItemId, AuctionId, AuctionItem, AuctionType};
...
impl AuctionHandler<AccountId, u128, u64, u64> for Handler {
    fn on_new_bid(_now: u64, _id: u64, new_bid: (AccountId, u128), _last_bid: Option<(AccountId, u128)>) -> OnNewBidResult<u64> {
        if new_bid.0 == ALICE {
            OnNewBidResult {
                accept_bid: true,
