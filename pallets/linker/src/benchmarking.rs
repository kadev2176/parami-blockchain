...
benchmarks! {
    ...
    link_btc {
        ...
        let account_id: T::AccountId = account("Alice", 0, SEED);
        let index: u32 = 0;
        let address = vec![49, 51, 121, 55, 106, 72, 52, 85, 57, 113, 68, 112, 69, 77, 77, 119, 87, 90, 117, 52, 99, 122, 52, 107, 55, 67, 81, 107, 90, 72, 100, 101, 113, 71];
        let expiring_block_number: u32 = 10000;
    ...
    }:  link_btc(RawOrigin::Signed(caller), account_id.clone(), index, address, expiring_block_number.into(), sig)
