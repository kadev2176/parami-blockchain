...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic,
    {
        ...
        ImOnline: pallet_im_online::{Pallet, Call, Storage, Event<T>, Config<T>} = 25,
        AuthorityDiscovery: pallet_authority_discovery::{Pallet, Config} = 26,
        Staking: pallet_staking::{Pallet, Call, Config<T>, Storage, Event<T>} = 27,
        Offences: pallet_offences::{Pallet, Storage, Event} = 28,
        Historical: pallet_session::historical::{Pallet} = 29,
        ...
        Council: pallet_collective::<Instance1>::{Pallet, Call, Storage, Origin<T>, Event<T>, Config<T>} = 41,
        TechnicalCommittee: pallet_collective::<Instance2>::{Pallet, Call, Storage, Origin<T>, Event<T>, Config<T>} = 42,
        PhragmenElection: pallet_elections_phragmen::{Pallet, Call, Storage, Event<T>, Config<T>} = 43,
        TechnicalMembership: pallet_membership::<Instance1>::{Pallet, Call, Storage, Event<T>, Config<T>} = 44,
        Treasury: pallet_treasury::{Pallet, Call, Storage, Config, Event<T>} = 45,

        // Miscellaneous.
        Bounties: pallet_bounties::{Pallet, Call, Storage, Event<T>} = 50,
        Contracts: pallet_contracts::{Pallet, Call, Storage, Event<T>} = 51,
        ElectionProviderMultiPhase: pallet_election_provider_multi_phase::{Pallet, Call, Storage, Event<T>, ValidateUnsigned} = 52,
        Mmr: pallet_mmr::{Pallet, Storage} = 53,
        Multisig: pallet_multisig::{Pallet, Call, Storage, Event<T>} = 54,
        RandomnessCollectiveFlip: pallet_randomness_collective_flip::{Pallet, Storage} = 55,
        Recovery: pallet_recovery::{Pallet, Call, Storage, Event<T>} = 56,
        Society: pallet_society::{Pallet, Call, Storage, Event<T>, Config<T>} = 57,
        Sudo: pallet_sudo::{Pallet, Call, Config<T>, Storage, Event<T>} = 58,
        Tips: pallet_tips::{Pallet, Call, Storage, Event<T>} = 59,
        Utility: pallet_utility::{Pallet, Call, Event} = 60,
        Vesting: pallet_vesting::{Pallet, Call, Storage, Event<T>, Config<T>} = 61,
