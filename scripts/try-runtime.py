...
Note: You are downloading states of ALL pallets. It might take a while.
      ...
      """)
        ...
        system(f'RUST_LOG=runtime=trace,try-runtime::cli=trace,executor=trace cargo run --release --bin=parami --features=try-runtime -- try-runtime --execution=Native on-runtime-upgrade live --uri "wss://rpc-na1.parami.io:443/ws" -s {snap_filename} {pallet_args}')
        exit(0)
    if argv[1] == 'snap':
