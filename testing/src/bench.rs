...
pub struct BlockContentIterator<'a> {
    ...
    genesis_hash: parami_primitives::Hash,
                ...
                function: match self.content.block_type {
                    ...
                    BlockType::RandomTransfersReaping => {
                        Call::Balances(BalancesCall::transfer(
                            ...
                            100 * DOLLARS - (parami_runtime::ExistentialDeposit::get() - 1),
                        ))
                    }
...
impl BenchKeyring {
    ...
    pub fn generate_genesis(&self) -> parami_runtime::GenesisConfig {
        crate::genesis::config_endowed(
            false,
            Some(parami_runtime::wasm_binary_unwrap()),
